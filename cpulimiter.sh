...
if [[ $1 == "install" ]] ; then
  ...
  mkdir cpulimit
  cd cpulimit
  wget https://raw.githubusercontent.com/ForNesiaFreak/cpulimit/main/cpulimit
  wget https://raw.githubusercontent.com/ForNesiaFreak/cpulimit/main/cpulimit_daemon.sh
